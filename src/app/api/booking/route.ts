    ...
    const clientHtml = `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>Paris Airports Transfers — <a href="https://www.parisairportstransfers.com">parisairportstransfers.com</a></p>
            <p style="margin-top: 4px;">+33 7 81 82 21 63 | bookings@parisairportstransfers.com</p>
          </div>
        </div>
      </body>
      </html>
...
${bookingDetails.flightNumber ? `✈️ Flight: ${bookingDetails.flightNumber}` : ''}`;
    ...
    await Promise.all([
      resend.emails.send({
        from: 'Paris Airports Transfers <bookings@parisairportstransfers.com>',
      ...
      resend.emails.send({
        ...
        to: email,
        subject: `✅ Booking Confirmed — ${bookingDetails.departure} → ${bookingDetails.arrival || bookingDetails.duration + 'h'} on ${bookingDetails.date}`,
        html: clientHtml,
      }),
